...
var KTLayoutSidebar = function () {
    var e = function (e, t, n, i) {
        var r = document.querySelector(t), o = parseInt(KTUtil.css(r, "height"));
        if (r) {
            var a = new ApexCharts(r, {
                ...
                yaxis: {crosshairs: {show: !1}, labels: {style: {colors: "#823FD9", fontSize: "12px"}}},
                states: {
                ...
                colors: ["#661DC5"],
                grid: {borderColor: "#661DC5", strokeDashArray: 4, yaxis: {lines: {show: !0}}}
            }), l = !1, s = document.querySelector(e);
